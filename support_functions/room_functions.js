...
var room_model = mongoose.model('room_collections', room_schema);
    ...
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                ...
                room_model.find().sort({ _id: -1 }).limit(1)
                    .then(function (data) {
                    if (data.length > 0) {
                        var new_id = parseInt(data[0].id) + 1;
                        new_room.id = new_id;
                    }
...
var remove_player = function (room_id, display_name) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var room_object, filter, update, new_array;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            ;
                            new_array = [];
                            room_object[0].players.forEach(function (player) {
